...
export function Overview() {
  ...
  const resetInitialValues = () => {
    ...
    setCompany(currentUser?.company?.name || 'No company');
    setPhone(currentUser.phone || 'No phone number');
      ...
      <div className="card mb-5 mb-xl-10" id="kt_profile_details_view">
        ...
        <div className="card-body p-9">
          <div className="row mb-7">
            <label className="col-lg-2 fw-bold d-flex align-items-center">First Name</label>
          ...
          <div className="row mb-7">
            <label className="col-lg-2 fw-bold d-flex align-items-center">Last Name</label>
            ...
            <div className="col-lg-8">
              {editModeVisible ? (
                ...
                <span className="fw-bold fs-6 text-muted">{userLastName}</span>
              )}
            </div>
          </div>
