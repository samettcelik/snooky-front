...
const Step5 = () => {
  ...
  const storeCampaignLimit = createCampaignStates.campaignLimit
    ...
    <div className="w-100 w-xxl-900px mx-auto">
      <div className="d-flex align-items-center mt-4">
        <input
          ...
          className="h1 inputTitle px-2 py-1 rounded mb-0 me-3"
          style={{
        ...
        <div className="d-flex align-items-center bg-light px-4 py-2 rounded ms-4">
          Draft <span className="bg-danger p-2 rounded-circle ms-2"></span>
        </div>
      </div>

      <div className="d-flex flex-column flex-md-row gap-5 my-8 w-100">
        <div className="card card-xl-stretch w-100">
          <div className="card-header border-0 pt-5">
            <h3 className="card-title flex-row ">
              <span className="card-label fw-bold fs-3 mb-1">Popup Design</span>
            </h3>
            <div className="card-toolbar">
              <div className='d-flex gap-4 justify-content-center align-items-center pe-4 me-4 border-end mt-3'>
                <div onClick={() => setIsMobile(false)} className={`${!isMobile ? 'border-primary' : 'border-white'} cursor-pointer border-2 border-bottom pb-2 px-2 d-flex flex-column align-items-center`}>
                  <CiLaptop className='w-25px h-25px' />
                  <GoDotFill className='w-10px h-10px text-success' />
                </div>
                <div onClick={() => setIsMobile(true)} className={`${isMobile ? 'border-primary' : 'border-white'} cursor-pointer border-2 border-bottom pb-2 px-2 d-flex flex-column align-items-center`}>
                  <CiMobile1 className='w-25px h-25px' />
                  <GoDotFill className='w-10px h-10px text-success' />
                </div>
              </div>
              <div className="d-flex align-items-center gap-2 pe-4 me-4">
                <svg
                ...
                <div className="d-flex flex-column ">
                  <div className="fs-6 fw-semibold">Reminder</div>
                  <div className="fs-8 fw-semibold text-success" style={{ marginTop: -4 }}>ON</div>
                </div>
              </div>
              <button
                type="button"
          ...
          <div className="card-body" style={{ marginTop: -6 }}>
            <div
              className="w-100 bg-light rounded-3"
              style={{
