      ...
      <div className="accordion-item mb-8 shadow border-top">
        <h2 className="accordion-header" id="headingThree">
          <button
            ...
            onClick={() => setCreateCampaignStates({ ...createCampaignStates, collapseNum: 3 })}
          >
            Discount Range
          </button>
        </h2>
        ...
        >
          ...
          <div className="d-flex justify-content-end">
            <button type="button" className="btn btn-sm btn-primary m-5" onClick={() => setCreateCampaignStates({ ...createCampaignStates, collapseNum: 4 })} id="headingTwo">Continue <KTIcon
