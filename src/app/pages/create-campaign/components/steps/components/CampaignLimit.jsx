    ...
    <div className="accordion-item mb-8 shadow border-top">
      <h2 className="accordion-header" id="headingFour">
        <button
          ...
          onClick={() => setCreateCampaignStates({ ...createCampaignStates, collapseNum: 4 })}
        >
          Campaign Limits
        </button>
      </h2>
      ...
      >
              ...
              <div className="d-inline-block">
                <div className="alert alert-secondary" style={storeCampaignLimit.selectedOption === 'Cart Value' ? { borderBottomLeftRadius: 0, borderBottomRightRadius: 0 } : null}>
                  ...
                  <label className="form-label fs-7 fw-bolder" htmlFor="productCardValue">
                    Cart Value
                    <CustomTooltip description="A minimum card value is required for your goal (Increase AOV). We recommend setting it slightly above your current AOV." />
                  </label>
                </div>
              </div>
        ...
        <div className="d-flex justify-content-end">
          <button type="button" className="btn btn-sm btn-primary m-5" onClick={() => setCreateCampaignStates({ ...createCampaignStates, collapseNum: 5 })} id="headingTwo">Continue <KTIcon
