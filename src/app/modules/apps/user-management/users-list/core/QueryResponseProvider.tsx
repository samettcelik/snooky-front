...
// import { useQuery, gql } from '@apollo/client'   // ============== New USE-QUERY use ==============
...
const QueryResponseProvider: FC<WithChildren> = ({ children }) => {
  ...
  // const { loading: getUsersLoading, error: getUsersError, data: getUsersData, refetch: getUsersRefetch } = useQuery(GET_POPUPS_QUERY)

  // useEffect(() => {
  //   const onCompleted = (data: any) => {
  //     const { GetUsersData }: { GetUsersData: any } = data
  //     setUsersData(GetUsersData.map((item) => ({ label: item.name, value: item.id })))
  //   };
