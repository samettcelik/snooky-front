...
function AddPaymentCardModal() {
    ...
    const addCard = async () => {
        ...
        const data = await SnookyClient.AddPaymentMethod({
            card_cvc: cardInfo.cvc,
            card_exp_month: cardInfo.expiry.split('/')[0],
            card_exp_year: cardInfo.expiry.split('/')[1],
            card_number: cardInfo.number,
            type: 'card'
        })
        console.log('DATA ADD PAYMENT METHOD');
        console.log(data);
